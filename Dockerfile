...
#RUN echo extension=php_xmlrpc.so >> /usr/local/etc/php/conf.d/xmlrpc.ini	
...
ADD site-scorecard.conf /etc/apache2/sites-available
RUN a2dissite 000-default.conf
RUN a2ensite site-scorecard.conf
